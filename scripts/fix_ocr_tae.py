...
MANUAL_OVERRIDES = {
    ...
    # === Completely wrong spell data (OCR matched wrong spell) ===
    "antipathy": "Un'area (fino a un cubo con spigolo di 3 m per livello) o un oggetto",
    "animal-shapes": "Fino a una creatura consenziente per livello, tutte entro 9 m l'una dall'altra",
    "bane": "Tutti i nemici entro 15 m",
    "bless": "L'incantatore e tutti gli alleati entro un'esplosione di 15 m centrata sull'incantatore",
    "break-enchantment": "Fino a una creatura per livello, tutte entro 9 m l'una dall'altra",
    "command-greater": "Una creatura/livello, non pi\u00f9 di 9 m l'una dall'altra",
    "contagion": "Creatura vivente toccata",
    "creeping-doom": "Uno sciame di centopiedi per ogni due livelli",
    "gate": "Vedi testo",
    "giant-vermin": "Fino a tre vermini, non pi\u00f9 di 9 m l'uno dall'altro",
    "grease": "Un oggetto o un quadrato con lato di 3 m",
    "halt-undead": "Fino a tre creature non morte, non pi\u00f9 di 9 m l'una dall'altra",
    "holy-smite": "Esplosione del raggio di 6 m",
    "message": "Una creatura/livello",
    "mirage-arcana": "Un cubo con spigolo di 6 m per livello (F)",
    "passwall": "Apertura di 1,5 m x 2,4 m, profonda 3 m + 1,5 m per ogni tre livelli aggiuntivi",
    "planar-ally-greater": "Fino a tre elementali o esterni richiamati, per un totale di non pi\u00f9 di 18 DV, non pi\u00f9 di 9 m l'uno dall'altro quando appaiono",
    "prayer": "Tutti gli alleati e i nemici entro un'esplosione del raggio di 12 m centrata sull'incantatore",
    "repel-wood": "Emanazione a forma di linea di 18 m che parte dall'incantatore",
    # === Wrong numbers / unit conversions ===
    "dispel-magic": "Un incantatore, una creatura o un oggetto; oppure un'esplosione del raggio di 6 m",
    "fabricate": "Fino a 0,3 m\u00b3/livello; vedi testo",
    "flaming-sphere": "Sfera di 1,5 m di diametro",
    "guards-and-wards": "Fino a 18,5 m\u00b2/livello (F)",
    # === OCR artifacts and grammar fixes ===
    "analyze-dweomer": "Un oggetto o creatura per livello dell'incantatore",
    "animal-growth": "Fino a un animale (Mastodontico o pi\u00f9 piccolo) per ogni due livelli, che non possono trovarsi a pi\u00f9 di 9 m l'uno dall'altro",
    "animal-trance": "Animali o bestie magiche con Intelligenza 1 o 2",
    "animate-dead": "Uno o pi\u00f9 cadaveri toccati",
    "create-water": "Fino a 7,5 l d'acqua per livello",
    "enlarge-person-mass": "Una creatura umanoide per livello, che non possono trovarsi a pi\u00f9 di 9 m l'una dall'altra",
    "feeblemind": "Una creatura",
    "heal-mount": "Cavalcatura toccata dall'incantatore",
    "hide-from-undead": "Una creatura toccata/livello",
    "identify": "Un oggetto toccato",
    "insect-plague": "Uno sciame di locuste per ogni tre livelli, ognuno dei quali deve essere adiacente ad almeno un altro sciame",
